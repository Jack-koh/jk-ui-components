...
function R(props: Props, ref: React.ForwardedRef<Element>) {
  const { className = "", onClick, onKeyDown, children: c, ...rest } = props;
...
export const Render = forwardRef<Element, Props>(R);
