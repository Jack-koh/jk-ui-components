                ...
                content={({ closeHandler }: any) => {
                  return (
                    <Modal.Content>
                      ...
                      <p>
                        Id sunt cupidatat sit elit deserunt cupidatat anim ipsum ad. Lorem quis enim
                        in ipsum eiusmod officia
                      </p>
                      <p>
                        voluptate et eiusmod nostrud cillum adipisicing nulla non. Labore aliquip
                        proident cupidatat do quis.
                      </p>
        ...
        content={({ closeHandler }: any) => {
          return (
            <Modal.Content>
              ...
              <p>
                Id sunt cupidatat sit elit deserunt cupidatat anim ipsum ad. Lorem quis enim in
                ipsum eiusmod officia
              </p>
              <p>
                voluptate et eiusmod nostrud cillum adipisicing nulla non. Labore aliquip proident
                cupidatat do quis.
              </p>
